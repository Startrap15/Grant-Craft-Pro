...
function getDefaultResponse(input) {
    ...
    if (lowercaseInput.includes('grant'))
        return defaultResponses.grant;
    if (lowercaseInput.includes('proposal'))
        return defaultResponses.proposal;
    if (lowercaseInput.includes('cost') || lowercaseInput.includes('price'))
        return defaultResponses.cost;
    if (lowercaseInput.includes('consultation'))
        return defaultResponses.consultation;
    if (lowercaseInput.includes('deadline'))
        return defaultResponses.deadline;
